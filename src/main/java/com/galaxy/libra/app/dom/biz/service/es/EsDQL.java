...
import com.galaxy.libra.app.dom.biz.service.DataDQL;
...
public class EsDQL implements DataDQL {
    ...
    public double calSum(String toSumField, String bucketKey, SearchRequest searchRequest) throws Exception {
    ...
    public Object calMax(String toMaxField, String bucketKey, SearchRequest searchRequest) throws Exception {
