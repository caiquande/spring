...
public class CalType1And4 extends RiskInsuredAmntBase {
    ...
    static class CT130136{
        //130,136
        public double CT14Special0(String indexName, String insuredNo, String riskCode, String polNo, String toGroupField, String toSumField,
    ...
    static class CT159172{
        ...
        public static double CT14Special1(String indexName, String insuredNo, String riskCode, String polNo, String toGroupField, String toSumField,
                                   double factor) throws Exception {
            final Callable<BoolQueryBuilder> queryBuilderCallable = () -> {
                return QueryBuilders.boolQuery()
                        .mustNot(QueryBuilders.termQuery("uwflag", "1"))
    ...
    static class CT190{
        //190
        public double CT14Special2(String indexName, String insuredNo, String riskCode, String polNo, String toGroupField, String toSumField, double factor) throws Exception {
            final Callable<BoolQueryBuilder> queryBuilderCallable = () -> {
                return QueryBuilders.boolQuery()
                        .mustNot(QueryBuilders.termQuery("uwflag", "1"))
                        .mustNot(QueryBuilders.termQuery("uwflag", "2"))
    ...
    static class CT331{
        ...
        public double CT14Special3(EsClient esClient, String indexName, String insuredNo, String riskCode, String polNo, String toGroupField,
            ...
            if (searchById != null) {
                ...
                if (age >= 18 && age <= 40) {
                    return CT159172.CT14Special1(indexName, insuredNo, riskCode, polNo, toGroupField, toSumField, 0.6);
                } else if (age >= 41 && age <= 60) {
                    return CT159172.CT14Special1(indexName, insuredNo, riskCode, polNo, toGroupField, toSumField, 0.4);
                } else if (age >= 61) {
                    return CT159172.CT14Special1(indexName, insuredNo, riskCode, polNo, toGroupField, toSumField, 0.2);
                } else {
                    return 0;
                }
            } else {
    ...
    static class CT428429{
        ...
        public double CT14Special4(EsClient esClient,String indexName, String insuredNo, String riskCode, String polNo) throws Exception {
            ...
            if (searchById != null) {
                age = Integer.valueOf(searchById.toString());
                if (age < 18) {
                    return CT159172.CT14Special1(indexName, insuredNo, riskCode, polNo, "insuredno", "amnt", 0.5);
                } else {
                    return CT159172.CT14Special1(indexName, insuredNo, riskCode, polNo, "insuredno", "riskamnt", 1);
                }
            } else {
                return 0;
            }
        ...
        public double CT14Special5(EsClient esClient,String indexName, String insuredNo, String riskCode, String polNo) throws Exception {
            ...
            if (searchById1 != null) {
                ...
                if (substring.compareTo(yyyyMMdd) >= 0) {
                    return CT159172.CT14Special1(indexName, insuredNo, riskCode, polNo, "insuredno", "amnt", 1.2);
                } else {
                    return CT159172.CT14Special1(indexName, insuredNo, riskCode, polNo, "insuredno", "amnt", 1.4);
                }
            } else {
                return 0;
            }
    ...
    static class CT685{
        //685
        public double CT14Special685(String indexName, String insuredNo, String riskCode, String polNo, String toGroupField,
                                       String toSumField,
            ...
            return runSum1Ext(indexName, insuredNo, riskCode, polNo, toGroupField, toSumField, payendyear,
                    queryBuilderCallable);
        }
        public double CT14Special6(String indexName, String insuredNo, String riskCode, String polNo, String toGroupField, String toSumField, int payendyear) throws Exception {
            final double part1 = CT159172.CT14Special1(indexName, insuredNo, riskCode, polNo, toGroupField, toSumField, 2);
            final double part2 = CT14Special685(indexName, insuredNo, riskCode, polNo, toGroupField, toSumField, 5);
            final double part3 = CT14Special685(indexName, insuredNo, riskCode, polNo, toGroupField, toSumField, 8);
